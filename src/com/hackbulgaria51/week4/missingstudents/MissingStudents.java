package com.hackbulgaria51.week4.missingstudents;
...
public class MissingStudents {
    public static Vector<Vector<String>> missingStudents(Vector<String> students, Vector<Vector<String>> presence) {
        ...
        for (Vector<String> vector : presence) {
            ...
            result.add(sortStudentsAlphabetically(missingStudents));
        }
        return result;
    }

    private static Vector<String> sortStudentsAlphabetically(Vector<String> missingStudents) {
        String temp = "";
